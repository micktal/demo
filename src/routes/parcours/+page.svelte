...
<section class="w-full bg-brand-green/5">
  <div class="container-1200 py-12 md:py-16 grid-12 items-center gap-6">
    <div class="col-span-12 md:col-span-7">
      ...
      <h1 class="mt-4">{t('parcours.title','Un parcours clair, du premier clic au certificat.')}</h1>
      <p class="mt-4 max-w-2xl">{t('parcours.subtitle','Chaque apprenant suit un chemin balisé, motivant et mesurable.')}</p>
    </div>
